...
def test_urlsafe_base64_encode():
    ...
    if six.PY2:
        ...
        assert urlsafe_base64_encode('abc123') == b'YWJjMTIz'
        assert urlsafe_base64_encode('"test@mailinator.com".DGxeoA.lCssU3M2QuBfohO-FtdgDQLKbU4') == b'InRlc3RAbWFpbGluYXRvci5jb20iLkRHeGVvQS5sQ3NzVTNNMlF1QmZvaE8tRnRkZ0RRTEtiVTQ'
        assert urlsafe_base64_encode('user+user@ctfd.io') == b'dXNlcit1c2VyQGN0ZmQuaW8'
        assert urlsafe_base64_encode('😆') == b'8J-Yhg'
...
def test_urlsafe_base64_decode():
    ...
    if six.PY2:
        ...
        assert urlsafe_base64_decode('YWJjMTIz') == b'abc123'
        assert urlsafe_base64_decode('InRlc3RAbWFpbGluYXRvci5jb20iLkRHeGVvQS5sQ3NzVTNNMlF1QmZvaE8tRnRkZ0RRTEtiVTQ') == b'"test@mailinator.com".DGxeoA.lCssU3M2QuBfohO-FtdgDQLKbU4'
        assert urlsafe_base64_decode('dXNlcit1c2VyQGN0ZmQuaW8=') == b'user+user@ctfd.io'
        assert urlsafe_base64_decode('dXNlcit1c2VyQGN0ZmQuaW8') == b'user+user@ctfd.io'
        assert urlsafe_base64_decode('8J-Yhg==') == b'😆'
        assert urlsafe_base64_decode('8J-Yhg') == b'😆'
