...
# Application ID of the shared OAuth application used for device flow login on
# gitlab.com. Deployments can override it with the GITLAB_CLIENT_ID setting
# to present their own application on the consent screen.
