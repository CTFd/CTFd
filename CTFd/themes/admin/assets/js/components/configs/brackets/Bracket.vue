    ...
    <div class="row">
      <div class="col-md-9">
        <div class="form-group">
          ...
          <small class="form-text text-muted">Bracket name (such as "Interns", "IT engineers", or "CS04 students")</small>
        </div>
      </div>
      ...
      <div class="col-md-12">
        ...
        <small class="form-text text-muted">If you are using Team Mode and would like the bracket to apply to entire teams instead of individuals, select Teams.</small>
      </div>
    </div>
