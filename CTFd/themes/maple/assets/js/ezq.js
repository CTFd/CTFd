...
const modalTpl =
  ...
  '    <div class="modal-content rpgui-container framed-golden" style="width: fit-content;margin-left: max(-5%, -10px)">' +
  '      <div class="modal-header">' +
  '        <h1 class="modal-title">{0}</h1>' +
...
const buttonTpl =
  '<button type="button" class="rpgui-button" data-dismiss="modal">{0}</button>';
const noTpl =
  '<button type="button" class="rpgui-button" data-dismiss="modal">No</button>';
const yesTpl =
  '<button type="button" class="rpgui-button" data-dismiss="modal">Yes</button>';
