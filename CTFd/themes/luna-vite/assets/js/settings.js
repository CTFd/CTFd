...
Alpine.data("TokensForm", () => ({
  ...
  init() {
    initModal(this.$refs.tokenModal, [], [this.$refs.tokenModalClose]);
  },
  ...
  async generateToken() {
    ...
    this.$refs.tokenModal.showModal();
  },
...
Alpine.data("Tokens", () => ({
  ...
  init() {
    this.hideModal = initModal(this.$refs.deleteModal, [], [this.$refs.deleteModalClose]);
  },
