...
//     var obj = challenges.find(function(chal) {
//         return chal.id == id;
//     })
...
//     $.get(script_root + '/chals/solves', function (solves) {
//         var chalids = Object.keys(solves);

//         for (var i = 0; i < chalids.length; i++) {
//             var obj = challenges.find(function(challenge) {
//                 return challenge.id == chalids[i]
//             })
...
//     $.get(script_root + "/chals", function (_challenges) {
//         var categories = [];

//         challenges = _challenges.game
