...
3. Copy your JAWSDB_MARIA_URL across to DATABASE_URL but **important** rename the protocol to `mysql+pymysql://`
4. Copy your REDISTOGO_URL over to REDIS_URL
5. TODO: could possibly automate that with a post build script, or could modify the fork to work with the autogenerated env vars.
